...
namespace Cherry.MessageBus
{
    public class MessageBus : IMessageBus
    {
        ...
        private string connectionString1 = "Endpoint=sb://cherryweb.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=CN0HnFwXobc2/k+DMUzcJVFWl7fwVSuGt+ASbM3gHT8=";
